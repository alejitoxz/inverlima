...
// funcion para charts de ordenbes de servicio por meses
function graficaAceite(tipoAceite){
var option;
if (tipoAceite==0) {
option="s.motorMarca";
}else if(tipoAceite==1){
option="s.cajaMarca";
}else if(tipoAceite==2){
option="s.transmicionMarca";
}else if(tipoAceite==3){
option="s.refrigeranteMarca";
}else if(tipoAceite==4){
option="s.hidraulicoMarca";
}
var fecha = $("#fecIni").val();
var inicioDate = fecha.substring(0, 16);
var finDate = fecha.substring(18, 38);
...
// funcion para charts de ordenbes de servicio por meses
function graficaLlanta(tipoLlanta){
var optionl;
if (tipoLlanta==0) {
optionl="s.llanta1Marca";
}else if(tipoLlanta==1){
optionl="s.llanta2Marca";
}else if(tipoLlanta==2){
optionl="s.llanta3Marca";
}else if(tipoLlanta==3){
optionl="s.llanta4Marca";
}else if(tipoLlanta==4){
optionl="s.llanta5Marca";
}else if(tipoLlanta==5){
optionl="s.llanta6Marca";
}
var fecha = $("#fecIni").val();
var inicioDate = fecha.substring(0, 16);
var finDate = fecha.substring(18, 38);
